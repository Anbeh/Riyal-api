...
gold_titles = {
    ...
    "مثقال طلا": "مثقال طلای ۱۸ عیار",
    "یک گرم طلای 18 عیار": "یک گرم طلای ۱۸ عیار",
    "سکه امامی": "سکه امامی جدید",
    "سکه بهار آزادی": "سکه بهار آزادی",
    "نیم سکه": "نیم سکه بانکی",
    "ربع سکه": "ربع سکه بانکی",
    "سکه گرمی": "سکه گرمی بانک ملی"
}
}
